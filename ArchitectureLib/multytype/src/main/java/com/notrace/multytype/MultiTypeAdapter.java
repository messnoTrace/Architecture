...
public class MultiTypeAdapter extends RecyclerView.Adapter<BindingViewHolder> {
    ...
    public void registerAll(@NonNull final TypePool pool) {
        ...
        for (int i = 0; i < size; i++) {
            Class clazz = pool.getClass(i);
            ItemViewBinder binder = pool.getItemViewBinder(i);
            Linker linker = pool.getLinker(i);
    ...
    @Override
    public final BindingViewHolder onCreateViewHolder(ViewGroup parent, int indexViewType) {
        if (inflater == null) {
            inflater = LayoutInflater.from(parent.getContext());
        }
        ItemViewBinder<?> binder = typePool.getItemViewBinder(indexViewType);

        ViewDataBinding binding = DataBindingUtil.inflate(inflater, binder.getLayoutId(), parent, false);
    ...
    public final void onBindViewHolder(@NonNull BindingViewHolder holder, int position) {
        ...
        if(binder.onBind(binding, items.get(position), position)){
    ...
    public final void onBindViewHolder(BindingViewHolder holder, int position, @NonNull List<Object> payloads) {
     ...
     * @see ItemViewBinder#onViewRecycled(BindingViewHolder)
     */
    @Override @SuppressWarnings("unchecked")
    public final void onViewRecycled(@NonNull BindingViewHolder holder) {
     ...
     * @see ItemViewBinder#onFailedToRecycleView(BindingViewHolder)
     */
    @Override @SuppressWarnings("unchecked")
    public final boolean onFailedToRecycleView(@NonNull BindingViewHolder holder) {
     ...
     * @see ItemViewBinder#onViewAttachedToWindow(BindingViewHolder)
     */
    @Override @SuppressWarnings("unchecked")
    public final void onViewAttachedToWindow(@NonNull BindingViewHolder holder) {
     ...
     * @see ItemViewBinder#onViewDetachedFromWindow(BindingViewHolder)
     */
    @Override @SuppressWarnings("unchecked")
    public final void onViewDetachedFromWindow(@NonNull BindingViewHolder holder) {
